 ...
 * @LastEditors: 言棠
 * @LastEditTime: 2022-09-15 14:02:05
 */
...
class BindTips extends Component<propType, StateType> {
    ...
    render() {
        ...
        return (
            <Modal centered open={this.state.bindingStateInfoModel} onCancel={() => this.setBindingStateInfoModel(false)} closable={false} footer={null} className="model-model-bindtips">

 ...
 * @LastEditors: 言棠
 * @LastEditTime: 2022-10-27 15:51:50
 */
...
import { percentMoney, getAssetsFile, interceptAfter5 } from "@/utils/common";
...
const Nft = (props: any) => {
  ...
  return (
    <>
      ...
      {/* hero开启成功 */}
      <CenterPopup visible={openHeroSuccessModel} onMaskClick={() => setOpenHeroSuccessModel(false)} className="model-model-nft-bindbox">

 ...
 * @LastEditors: 言棠
 * @LastEditTime: 2022-11-01 14:56:17
 */
import { useState, useEffect } from "react";
import { connect } from "react-redux";
import { useNavigate } from 'react-router-dom';
import { interceptStr, percentMoney, getAssetsFile } from "@/utils/common";
                      ...
                      <div key={index} className="info_item">
                        <div className="first_row">
                          ...
                          <div className="right">
                            ...
                            <div className="line_2_row">
                              <span>#{item.heroId}</span>

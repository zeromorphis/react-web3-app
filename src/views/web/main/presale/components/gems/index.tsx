...
const PresaleGems = (props: any) => {
  ...
  return (
    <>
      ...
      {/* gems(equip)价格弹框 */}
      <Modal centered open={buyNowEquipModel} onCancel={() => setBuyNowEquipModel(false)} footer={null} className="model-model-presale-gems">
      ...
      {/* gems(equip)开启成功 */}
      <Modal centered open={openEquipSuccessModel} onCancel={() => setOpenEquipSuccessModel(false)} closable={false} footer={null} className="model-model-presale-gems">

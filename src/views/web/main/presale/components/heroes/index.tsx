...
const PresaleHeroes = (props: any) => {
  ...
  return (
    <>
      <div className="presale_heroes_container">
        <div className="main_wrap">
          <div className='title'>
            ...
            <p>Get ready for the genesis NFT offerings! You will find exclusive benefits to presale items &</p>
            <p>your chance to get a head start before game launch. So, are you ready to become the Golden Bros?</p>
          </div>
      ...
      {/* hero价格弹框 */}
      <Modal centered open={buyNowHeroModel} onCancel={() => setBuyNowHeroModel(false)} footer={null} className="model-model-presale-heroes">
      ...
      {/* hero购买成功 */}
      <Modal centered open={buyNowHeroSuccessModel} onCancel={() => setBuyNowHeroSuccessModel(false)} closable={false} footer={null} className="model-model-presale-heroes">
      ...
      {/* hero开启成功 */}
      <Modal centered open={openHeroSuccessModel} onCancel={() => setOpenHeroSuccessModel(false)} closable={false} footer={null} className="model-model-presale-heroes">

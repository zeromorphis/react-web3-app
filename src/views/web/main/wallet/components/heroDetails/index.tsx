 ...
 * @LastEditors: 言棠
 * @LastEditTime: 2022-10-20 18:12:50
 */
...
const WalletHeroDetails: React.FC = (props: any) => {
  ...
  return (
    <>
                ...
                }
                {
                  heroInfoDetails.tradingStatus && heroInfoDetails.tradingStatus == '0' ? (
                    ...
                    <div className="btn_wrap justify-content-center">
                      ...
                      {/* <Button className="btn btn2" type="primary">Ascending Order</Button> */}
                    </div>
                  )
                }
              </div>
      ...
      <Modal centered open={saleNowModel} onCancel={() => setSaleNowModel(false)} footer={null} className="model-model-walletHeroDetails">

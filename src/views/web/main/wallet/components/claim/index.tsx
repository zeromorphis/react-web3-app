 ...
 * @LastEditors: 言棠
 * @LastEditTime: 2022-09-30 16:25:36
 */
...
import BindTips from "@/components/web/BindTips";
import "./index.less";
                  ...
                  <ul className="data">
                    {
                      state.withdrawHistoryList.map((item: any, index: number) => {
                        return <li key={index}>
                          ...
                          <div className="li_item">
                            <span>{percentMoney(item.applicationAmount, 3)}</span>
                          </div>
                          <div className="li_item">
                            <span>{interceptStr(item.applicant, 6)}</span>
                          </div>
                          <div className="li_item">
